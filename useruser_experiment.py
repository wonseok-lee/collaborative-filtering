...
def user_dot_mean(path, k):
    ...
    rating = 'user_dot_mean'

    return mean_result, rating


def user_dot_weigthed_mean(path, k):
    name = 'user'
    ...
    rating = 'user_dot_weigthed_mean'

    return weighted_mean_result, rating

def user_cos_mean(path, k):
    name = 'user'
    ...
    rating = 'user_cos_mean'

    return mean_result, rating

def user_cos_weigthedmean(path, k):
    name = 'user'
